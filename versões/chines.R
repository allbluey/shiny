...
disciplinas2 <- sort(unique(media1$Disciplinas))
                          ...
                          sidebarLayout(
                            ...
                            tabPanel("Tabelas", 
                                     sidebarLayout(
                                       ...
                                       mainPanel(
                                        tabsetPanel(
                                          tabPanel(p(icon("table"), "Notas em geral"),
                                         dataTableOutput(outputId="dTable")),
                                         tabPanel(p(icon("table"), "Médias"),
                                                  dataTableOutput(outputId="dMedia")))
                                       )
                                     )
                                  ),
