...
fy <- fy %>% filter(`Ano Ingresso` == 2005 | `Ano Ingresso` == 2006 | `Ano Ingresso` == 2007)
#----------------------------------------------------------------------------------------------------
...
server <- function(input, output){
  ...
  selectData <- reactive({
    if(input$anos == 2005 & input$disciplina %in% c("MD141","MD142","MD148","MD241", "MD242","MD243","MD244","MD248",
    ...
    else if (input$anos == 2006 & input$disciplina %in% c("MD141","MD142","MD148","MD241", "MD242","MD243","MD244","MD248",
                                                          "MD342","MD343","MD344","MD348","MD542","MD442","MD443","MD444","MD445","MD447","MD448","MD449",
                                                          "MD543","MD544","MD546","MD548","MD643","MD644","MD646","MD748","MD752","MD753","MD754","MD758","MD759",
                                                          "MD941","MD942","MD943","MD944","MD945","MD127","MD131","MD132","MD133","MD134","MD135","MD136","MD138","MD139"))
      return( fy %>% 
    ...
    else if(input$anos == 2007 & input$disciplina %in% c("MD141","MD142","MD148","MD241", "MD242","MD243","MD244","MD248",
                                                        "MD342","MD343","MD344","MD348","MD542","MD442","MD443","MD444","MD445","MD447","MD448","MD449",
                                                        "MD543","MD544","MD546","MD548","MD643","MD644","MD646","MD748","MD752","MD753","MD754","MD758","MD759",
                                                        "MD941","MD942","MD943","MD944","MD945","MD127","MD131","MD132","MD133","MD134","MD135","MD136","MD138","MD139"))
      return(fy %>% 
